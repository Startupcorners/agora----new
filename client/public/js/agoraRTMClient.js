...
export const setupAgoraRTMClient = (config) => {
  ...
  console.log("Agora appId:", config.appId);
  ...
  let channelJoined = false; // Add a flag to track if the channel has been joined
  ...
  return { clientRTM, channelRTM, channelJoined }; // Return the flag with the RTM objects
};
